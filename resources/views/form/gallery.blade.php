    ...
    <table class="table">
      ...
      @foreach ($galleries as $gallery)
              <tr>
                     ...
                     <td>{{$gallery->slug}}</td>
                     <td>
                        <a href="{{route('deleteGallery',$gallery->id)}}" onclick="confirm('Are you sure ,You want to delete this Category ?') || event.stopImmediatePropagation()">
