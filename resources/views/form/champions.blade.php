...
@section('menu')
@extends('sidebar.champions_staff')
@endsection
@section('content')
<div id="main">
    <header class="mb-3">
    ...
    <table class="table">
      ...
      @foreach ($champions as $champion)
              <tr>
                     ...
                     <td>{{$champion->slug}}</td>
                     <td>
                        <a href="{{route('deleteChampion',$champion->id)}}" onclick="confirm('Are you sure ,You want to delete this Category ?') || event.stopImmediatePropagation()">
